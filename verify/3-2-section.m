/*
    Checking that the groups in Table 3.1 all have H (and H+) conjugate to its
    transpose, as promised in section 3.2.
*/
...
// Load level 4 data from Table 3.1
G := GL(2, Integers(4));
...
// Load level 8 data from Table 3.1
G := GL(2, Integers(8));
...
// Load level 16 data from Table 3.1
G := GL(2, Integers(16));
